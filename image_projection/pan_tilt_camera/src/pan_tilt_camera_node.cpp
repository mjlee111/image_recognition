...
PanTiltCamera::on_configure(const rclcpp_lifecycle::State &)
{
  ...
  pan_tilt_status_pub_ = this->create_publisher<image_recognition_msgs::msg::PanTiltStatusMsgs>(
    pan_tilt_status_topic.c_str(), 1);
  pan_tilt_sub_ = this->create_subscription<image_recognition_msgs::msg::PanTiltMsgs>(
...
void PanTiltCamera::pan_tilt_callback(const image_recognition_msgs::msg::PanTiltMsgs::SharedPtr msg)
{
...
void PanTiltCamera::publish_pan_tilt_status()
{
  ...
  header.stamp = this->now();
  header.frame_id = frame_id;
  image_recognition_msgs::msg::PanTiltStatusMsgs status_msg;
